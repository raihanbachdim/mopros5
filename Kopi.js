const kopi = [
  {
    coffee_id:'1', 
    coffee_title:'Caffé Latte', 
    coffee_detail:'Rich, full-bodied espresso in steamed milk, lightly topped with foam. A caffé latte is simply a shot or two of bold, tasty espresso with fresh, sweet steamed milk over it.',  
    coffee_thumbnails:require('../Assets/caffe_latte_thumbnail.png'),
    coffee_poster:require('../Assets/caffe_latte_poster.jpg')
    },
    {
    coffee_id:'2', 
    coffee_title:'Cappuccino', 
    coffee_detail:'Espresso with steamed milk, topped with a deep layer of foam.',  
    coffee_thumbnails:require('../Assets/cappuccino_thumbnail.png'),
    coffee_poster:require('../Assets/cappuccino_poster.jpg')
    },
    {
    coffee_id:'3', 
    coffee_title:'Caffé Mocha', 
    coffee_detail:'Espresso with bittersweet mocha sauce and steamed milk, topped with sweetened whipped cream. Delightful.',  
    coffee_thumbnails:require('../Assets/caffe_mocha_thumbnail.png'),
    coffee_poster:require('../Assets/caffe_mocha_poster.jpg')
    },
    {
    coffee_id:'4', 
    ...
    coffee_thumbnails:require('../Assets/caramel_macchiato_thumbnail.png'),
    coffee_poster:require('../Assets/caramel_macchiato_poster.jpg')
    },
    {
    coffee_id:'5', 
    ...
    coffee_thumbnails:require('../Assets/vanilla_sweet_cream_cold_brew_thumbnail.png'),
    coffee_poster:require('../Assets/vanilla_sweet_cream_cold_brew_poster.jpg')
    },
    {
    coffee_id:'6', 
    ...
    coffee_thumbnails:require('../Assets/cold_brew_thumbnail.png'),
    coffee_poster:require('../Assets/cold_brew_poster.jpg')
    },
    {
    coffee_id:'7', 
    ...
    coffee_thumbnails:require('../Assets/mango_passion_frappuccino_thumbnail.png'),
    coffee_poster:require('../Assets/mango_passion_frappuccino_poster.jpg')
    },
    {
    coffee_id:'8', 
    coffee_title:'Raspberry Currant Frappuccino', 
    coffee_detail:'Made with freshly brewed Teavana® tea, blended juice and ice.',  
    coffee_thumbnails:require('../Assets/raspberry_currant_frappuccino_thumbnail.png'),
    coffee_poster:require('../Assets/raspberry_currant_frappuccino_poster.jpg')
    },
    {
    coffee_id:'9', 
    ...
    coffee_thumbnails:require('../Assets/coffee_frappuccino_thumbnail.png'),
    coffee_poster:require('../Assets/coffee_frappuccino_poster.jpg')
    },
    {
    coffee_id:'10', 
    ...
    coffee_thumbnails:require('../Assets/mocha_frappuccino_thumbnail.png'),
    coffee_poster:require('../Assets/mocha_frappuccino_poster.jpg')
    },
